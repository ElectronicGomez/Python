...
#        self.master.after(10, self.paralelo)
    ...
    def ActPrecio(self):
        ...
        if self.anterior!=0:
            if   res< 0: self.lblPrecioAct.config(text=f"{act:,.2f} USD", fg="red")
            elif res> 0: self.lblPrecioAct.config(text=f"{act:,.2f} USD", fg="green")
            elif res==0: self.lblPrecioAct.config(text=f"{act:,.2f} USD", fg="black")
        else:
            self.lblPrecioAct.config(text=f"{act:,.2f} USD", fg="black")
